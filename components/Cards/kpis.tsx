...
import type { Receipt } from "../../src/interface/Receipt/receiptDto"; // Ajuste o caminho se necessário

interface KpisProps {
    dados: Receipt[];
}

export default function Kpis({ dados }: KpisProps) {

    // Calculamos os valores automaticamente sempre que 'dados' mudar
        ...
        <div className="kpi-section">
            ...
            <div className="card-kpi kpi-total">
                <div className="kpi-info">
                    ...
                    <span className="kpi-valor">{indicadores.total}</span>
                </div>
            ...
            {/* Card 2: NA FILA (Pendentes) */}
            <div className="card-kpi kpi-fila">
                <div className="kpi-info">
                    <span className="kpi-titulo">Em Processo</span>
                    <span className="kpi-valor">{indicadores.fila}</span>
                </div>
            ...
            <div className="card-kpi kpi-finalizado">
                <div className="kpi-info">
                    ...
                    <span className="kpi-valor">{indicadores.finalizados}</span>
                </div>
            ...
            <div className="card-kpi kpi-divergencia">
                <div className="kpi-info">
                    ...
                    <span className="kpi-valor">{indicadores.divergencias}</span>
                </div>
